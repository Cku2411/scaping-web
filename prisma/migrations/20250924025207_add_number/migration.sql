...
INSERT INTO "new_ExecutionPhase" ("completedAt", "creditsCost", "id", "inputs", "node", "outputs", "startedAt", "status", "userId", "workflowExecutionId") SELECT "completedAt", "creditsCost", "id", "inputs", "node", "outputs", "startedAt", "status", "userId", "workflowExecutionId" FROM "ExecutionPhase";
